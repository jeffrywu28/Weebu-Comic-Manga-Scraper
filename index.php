...
<div class="container-fluid" style="padding: 0 20% 0 20%;">
  <?php
  $count=1;
  echo '<div class="row" style="margin-top: 1em;" style="margin: auto;">';
  foreach($html->find('a.item-img') as $element){
    ?>
    <div class="col-md-3">
      <div class="card text-center" style="width: 200px;">
      <a class="card-block stretched-link text-decoration-none" href="manga.php?manga=<?php echo $element->href; ?>">
